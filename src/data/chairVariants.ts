import type { CatalogEntry, ChairVariantDef } from '../types';
...
const manual: ChairVariantDef = {
  ...
  parts: [
    ...
    { id: 'wheelLeft', label: 'Roue gauche', kind: 'cylinder', args: [0.3, 0.3, 0.045, 32], position: [-0.29, 0.3, 0.03], rotation: [0, 0, Math.PI / 2], defaultColor: '#111111', roughness: 0.8, spoked: true },
    { id: 'wheelRight', label: 'Roue droite', kind: 'cylinder', args: [0.3, 0.3, 0.045, 32], position: [0.29, 0.3, 0.03], rotation: [0, 0, Math.PI / 2], defaultColor: '#111111', roughness: 0.8, spoked: true },
...
const sport: ChairVariantDef = {
  ...
  parts: [
    ...
    { id: 'wheelLeft', label: 'Roue gauche', kind: 'cylinder', args: [0.32, 0.32, 0.04, 32], position: [-0.31, 0.32, 0.02], rotation: [0, 0, Math.PI / 2 - 0.12], defaultColor: '#161616', roughness: 0.8, spoked: true },
    { id: 'wheelRight', label: 'Roue droite', kind: 'cylinder', args: [0.32, 0.32, 0.04, 32], position: [0.31, 0.32, 0.02], rotation: [0, 0, Math.PI / 2 + 0.12], defaultColor: '#161616', roughness: 0.8, spoked: true },
...
const electric: ChairVariantDef = {
  ...
  parts: [
    ...
    { id: 'seatCushion', label: 'Coussin d’assise', kind: 'box', args: [0.4, 0.03, 0.4], position: [0, 0.585, 0.02], defaultColor: '#454545', roughness: 0.9 },
    { id: 'backrest', label: 'Dossier', kind: 'box', args: [0.44, 0.55, 0.07], position: [0, 0.82, -0.19], rotation: [-0.1, 0, 0], defaultColor: '#3a3a3a', roughness: 0.85 },
    { id: 'backCushion', label: 'Coussin de dossier', kind: 'box', args: [0.38, 0.48, 0.03], position: [0, 0.84, -0.16], rotation: [-0.1, 0, 0], defaultColor: '#454545', roughness: 0.9 },
    { id: 'headrest', label: 'Appui-tête', kind: 'box', args: [0.22, 0.14, 0.06], position: [0, 1.16, -0.16], rotation: [0.15, 0, 0], defaultColor: '#3a3a3a', roughness: 0.85, removable: true },
    { id: 'driveWheelLeft', label: 'Roue motrice gauche', kind: 'cylinder', args: [0.19, 0.19, 0.09, 24], position: [-0.32, 0.19, -0.02], rotation: [0, 0, Math.PI / 2], defaultColor: '#111111', roughness: 0.8, spoked: true },
    { id: 'driveWheelRight', label: 'Roue motrice droite', kind: 'cylinder', args: [0.19, 0.19, 0.09, 24], position: [0.32, 0.19, -0.02], rotation: [0, 0, Math.PI / 2], defaultColor: '#111111', roughness: 0.8, spoked: true },
    ...
    { id: 'stabilizerFront', label: 'Roulette stabilisatrice avant', kind: 'sphere', args: [0.035, 14, 14], position: [0, 0.035, 0.34], defaultColor: '#1a1a1a', removable: true },
    { id: 'stabilizerRear', label: 'Roulette stabilisatrice arrière', kind: 'sphere', args: [0.035, 14, 14], position: [0, 0.035, -0.34], defaultColor: '#1a1a1a', removable: true },
...
export const CATALOG_ENTRIES: CatalogEntry[] = [
  {
    ...
    name: 'Fauteuil manuel standard',
    description: 'Châssis pliable classique, grandes roues à main courante.',
    previewImage: previewSrc('manual.jpg'),
    photoCredit: 'Photo : Mike Bates, domaine public (Wikimedia Commons)',
    baseVariantId: 'manual',
  },
  {
    id: 'sport',
    name: 'Fauteuil sport / léger',
    description: 'Châssis rigide bas, roues carrossées, sans accoudoirs.',
    previewImage: previewSrc('sport.jpg'),
    photoCredit: 'Photo : Tim99 (Wikimedia Commons), CC BY-SA 4.0',
    baseVariantId: 'sport',
  },
  {
    id: 'electric',
    name: 'Fauteuil électrique',
    description: 'Base motorisée, batterie, roues motrices arrière, joystick.',
    previewImage: previewSrc('electric.jpg'),
    photoCredit: 'Photo : Stephen B Calvert (Wikimedia Commons), CC BY-SA 3.0',
    baseVariantId: 'electric',
  },
  {
    id: 'standing',
    name: 'Fauteuil verticalisateur',
    description: 'Fauteuil électrique qui permet de se mettre debout progressivement.',
    previewImage: previewSrc('standing.jpg'),
    photoCredit: 'Photo : Hoagy-dubh (Wikimedia Commons), CC BY-SA 4.0',
    baseVariantId: 'electric',
  },
  {
    id: 'beach',
    name: 'Fauteuil de plage',
    description: 'Grandes roues ballon increvables pour rouler sur le sable.',
    previewImage: previewSrc('beach.jpg'),
    photoCredit: 'Photo : Martin Kliehm (Wikimedia Commons), CC BY-SA 2.0',
    baseVariantId: 'manual',
  },
];
